...
#define YELLOW_TEXT "\033[38;2;227;212;173m" //"\033[0;33m"
...
void printboard(const std::vector<std::vector<int>> &board)
{
    ...
    for (int i = 0; i < 6; ++i)
    {
        ...
        for (int j = 0; j < 7; ++j)
        {
            if (board[i][j] == 1)
            {
                std::cout << YELLOW_TEXT << "O" << RESET_TEXT;
            }
            else if (board[i][j] == -1)
            {
                std::cout << RED_TEXT << "O" << RESET_TEXT;
            }
            else
            {
                std::cout << " ";
...
bool gewonnen(const std::vector<std::vector<int>> &board, int player)
{
    ...
    for (int q = 0; q < 4; ++q)
    {
        for (int w = 0; w < 6; ++w)
        {
            if (board[w][q] == player && board[w][q + 1] == player && board[w][q + 2] == player && board[w][q + 3] == player)
            {
                gewonnen = true;
            }
        }
    ...
    for (int q = 0; q < 7; ++q)
    {
        for (int w = 0; w < 3; ++w)
        {
            if (board[w][q] == player && board[w + 1][q] == player && board[w + 2][q] == player && board[w + 3][q] == player)
            {
                gewonnen = true;
            }
        }
    ...
    for (int q = 0; q < 4; ++q)
    {
        for (int w = 0; w < 3; ++w)
        {
            if (board[w][q] == player && board[w + 1][q + 1] == player && board[w + 2][q + 2] == player && board[w + 3][q + 3] == player)
            {
                gewonnen = true;
            }
        }
    ...
    for (int q = 0; q < 4; ++q)
    {
        for (int w = 0; w < 3; ++w)
        {
            if (board[w][q + 3] == player && board[w + 1][q + 2] == player && board[w + 2][q + 1] == player && board[w + 3][q] == player)
            {
                gewonnen = true;
            }
        }
...
int evaluate_position(const std::vector<std::vector<int>> &board, int player)
{
    ...
    for (int q = 0; q < 4; ++q)
    {
        for (int w = 0; w < 6; ++w)
        {
            ...
            else if (board[w][q + 1] == 0)
            {
                empty += 1;
            }
            else if (board[w][q + 1] == otherplayer)
            {
                other += 1;
            }
            //
            ...
            else if (board[w][q + 2] == 0)
            {
                empty += 1;
            }
            else if (board[w][q + 2] == otherplayer)
            {
                other += 1;
            }
            //
            ...
            else if (board[w][q + 3] == 0)
            {
                empty += 1;
            }
            else if (board[w][q + 3] == otherplayer)
            {
                other += 1;
            }
            //
    ...
    for (int e = 0; e < 7; ++e)
    {
        for (int r = 0; r < 3; ++r)
        {
            ...
            else if (board[r][e] == otherplayer)
            {
                other += 1;
            }
            //
            if (board[r + 1][e] == player)
            {
                filled += 1;
            }
            else if (board[r + 1][e] == 0)
            {
                empty += 1;
            }
            else if (board[r + 1][e] == otherplayer)
            {
                other += 1;
            }
            //
            if (board[r + 2][e] == player)
            {
                filled += 1;
            }
            else if (board[r + 2][e] == 0)
            {
                empty += 1;
            }
            else if (board[r + 2][e] == otherplayer)
            {
                other += 1;
            }
            //
            if (board[r + 3][e] == player)
            {
                filled += 1;
            }
            else if (board[r + 3][e] == 0)
            {
                empty += 1;
            }
            else if (board[r + 3][e] == otherplayer)
            {
                other += 1;
            }
            //
    ...
    for (int a = 0; a < 4; ++a)
    {
        for (int s = 0; s < 3; ++s)
        {
            ...
            else if (board[s][a] == otherplayer)
            {
                other += 1;
            }
            //
            if (board[s + 1][a + 1] == player)
            {
                filled += 1;
            }
            else if (board[s + 1][a + 1] == 0)
            {
                empty += 1;
            }
            else if (board[s + 1][a + 1] == otherplayer)
            {
                other += 1;
            }
            //
            if (board[s + 2][a + 2] == player)
            {
                filled += 1;
            }
            else if (board[s + 2][a + 2] == 0)
            {
                empty += 1;
            }
            else if (board[s + 2][a + 2] == otherplayer)
            {
                other += 1;
            }
            //
            if (board[s + 3][a + 3] == player)
            {
                filled += 1;
            }
            else if (board[s + 3][a + 3] == 0)
            {
                empty += 1;
            }
            else if (board[s + 3][a + 3] == otherplayer)
            {
                other += 1;
            }
            //
    ...
    for (int y = 0; y < 4; ++y)
    {
        for (int x = 0; x < 3; ++x)
        {
            ...
            else if (board[x][y + 3] == otherplayer)
            {
                other += 1;
            }
            //
            ...
            else if (board[x + 1][y + 2] == 0)
            {
                empty += 1;
            }
            else if (board[x + 1][y + 2] == otherplayer)
            {
                other += 1;
            }
            //
            ...
            else if (board[x + 2][y + 1] == 0)
            {
                empty += 1;
            }
            else if (board[x + 2][y + 1] == otherplayer)
            {
                other += 1;
            }
            //
            ...
            else if (board[x + 3][y] == otherplayer)
            {
                other += 1;
            }
            //
